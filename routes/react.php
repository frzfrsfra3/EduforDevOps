...
$this->post('logins', 'Auth\LoginController@logins');
...
$this->get('admin/password/reset', 'User\ForgotPasswordController@showLinkRequestForm')->name('password.request');
$this->post('admin/password/email', 'AUseruth\ForgotPasswordController@sendResetLinkEmail')->name('password.email');
$this->get('admin/password/reset/{token}', 'User\ResetPasswordController@showResetForm')->name('password.reset');
$this->post('admin/password/reset', 'User\ResetPasswordController@reset');
...
Route::group(
    ...
    $this->post('registers', 'Auth\RegisterController@registers');
